...
TutorialModel::TutorialModel() : QAbstractTableModel() {
...
QVariant TutorialModel::data(const QModelIndex &index, int role) const {
    ...
    switch (index.column()) {
        ...
        case 5: {
            std::string duration = std::to_string(tut.getDuration().getMinutes()) + ":" +
                                   std::to_string(tut.getDuration().getMinutes());
...
bool TutorialModel::removeTutorialFromRepository(Tutorial t) {
    Tutorial v = t;
    beginInsertRows(QModelIndex(), 0, 0);
...
bool TutorialModel::updateTutorialFromRepository(Tutorial t, Tutorial t1) {
    Tutorial v = t;
    beginInsertRows(QModelIndex(), 0, 0);
    repo->removeTutorial(v.getPresenter(), v.getTitle());
    endInsertRows();
    ...
    try {
        ...
        beginInsertRows(QModelIndex(), 0, 0);
        repo->addTutorial(t1);
        std::unique_ptr<Action> action{new UpdateAction{repo, t, t1}};
        undoActions.push_back(std::move(action));
        redoActions.clear();
        endInsertRows();
        return true;
...
Qt::ItemFlags TutorialModel::flags(const QModelIndex &index) const {
    if (index.column() == 6)
        return static_cast<QFlag>(Qt::DisplayRole);
    ...
    try {
        ...
        switch (index.column()) {
            case 0: {
                ...
                repo->updateTutorial(TutorialFactory::MakeTutorial(p.getTitle(), value.toString().toStdString(),
                                     ...
                                     p.getTitle());
                Tutorial newT = Tutorial{p.getTitle(), value.toString().toStdString(),
            ...
            case 1: {
                ...
                repo->updateTutorial(TutorialFactory::MakeTutorial(value.toString().toStdString(), p.getPresenter(),
                                                                   std::to_string(p.getDuration().getMinutes()),
                                                                   std::to_string(p.getDuration().getSeconds()),
                                                                   std::to_string(p.getNoLikes()), p.getSource(),
                                                                   std::to_string(p.getNoViews())), p.getPresenter(),
                                     title);
                Tutorial newT = TutorialFactory::MakeTutorial(value.toString().toStdString(), p.getPresenter(),
                                                              std::to_string(p.getDuration().getMinutes()),
                                                              std::to_string(p.getDuration().getSeconds()),
                                                              std::to_string(p.getNoLikes()), p.getSource(),
            ...
            case 2: {
                ...
                repo->updateTutorial(TutorialFactory::MakeTutorial(p.getTitle(), p.getPresenter(),
                                                                   std::to_string(p.getDuration().getMinutes()),
                                                                   std::to_string(p.getDuration().getSeconds()),
                                                                   noLikes, p.getSource(),
                                                                   std::to_string(p.getNoViews())), p.getPresenter(),
                                     p.getTitle());
                Tutorial newT = TutorialFactory::MakeTutorial(p.getTitle(), p.getPresenter(),
                                                              std::to_string(p.getDuration().getMinutes()),
            ...
            case 3: {
                ...
                repo->updateTutorial(TutorialFactory::MakeTutorial(p.getTitle(), p.getPresenter(),
                                                                   ...
                                                                   std::to_string(p.getDuration().getSeconds()),
                                                                   std::to_string(p.getNoLikes()), p.getSource(),
                                                                   value.toString().toStdString()), p.getPresenter(),
                                     p.getTitle());
                Tutorial newT = TutorialFactory::MakeTutorial(p.getTitle(), p.getPresenter(),
                                                              std::to_string(p.getDuration().getMinutes()),
                                                              std::to_string(p.getDuration().getSeconds()),
            ...
            case 4: {
                ...
                repo->updateTutorial(TutorialFactory::MakeTutorial(p.getTitle(), p.getPresenter(),
                                                                   std::to_string(p.getDuration().getMinutes()),
                                                                   std::to_string(p.getDuration().getSeconds()),
                                                                   std::to_string(p.getNoLikes()), source,
                                                                   std::to_string(p.getNoViews())), p.getPresenter(),
                                     p.getTitle());
                Tutorial newT = TutorialFactory::MakeTutorial(p.getTitle(), p.getPresenter(),
                                                              std::to_string(p.getDuration().getMinutes()),
            ...
            case 5: {
                ...
                repo->updateTutorial(TutorialFactory::MakeTutorial(p.getTitle(), p.getPresenter(), durationTokens[0],
                                                                   durationTokens[1], std::to_string(p.getNoLikes()),
                                                                   p.getSource(), std::to_string(p.getNoViews())),
                                     p.getPresenter(), p.getTitle());
                Tutorial newT = TutorialFactory::MakeTutorial(p.getTitle(), p.getPresenter(), durationTokens[0],
                                                              durationTokens[1], std::to_string(p.getNoLikes()),
                                                              p.getSource(), std::to_string(p.getNoViews()));
                std::unique_ptr<Action> action{new UpdateAction(repo, p, newT)};
                undoActions.push_back(std::move(action));
...
void TutorialModel::likeTutorial(Tutorial t) {
    ...
    likes--;
    Tutorial p = Tutorial(t.getTitle(), t.getPresenter(),
                          Duration{t.getDuration().getMinutes(), t.getDuration().getSeconds()}, likes, t.getSource(),
                          t.getNoViews());
