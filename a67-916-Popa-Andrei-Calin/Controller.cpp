...
bool Controller::updateTutorialFromRepository(const std::string &presenter, const std::string &title, Tutorial nT) {
    ...
    if ((newT.getPresenter() != "" || newT.getTitle() != "") &&
        (nT.getPresenter() != presenter && nT.getTitle() != title))
        return false;
...
bool Controller::likeTutorial() {
    ...
    return this->updateTutorialFromRepository(t.getPresenter(), t.getTitle(),
                                              Tutorial{t.getTitle(), t.getPresenter(), t.getDuration(), t.getNoLikes(),
                                                       t.getSource(), t.getNoViews()});
